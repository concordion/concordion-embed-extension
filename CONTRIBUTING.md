...
`./gradlew install`
    - to build the jar file and install to the local Maven repository. (For reference on how to use the Maven local repository in a Gradle project, see the `dev.gradle` file in the concordion-screenshot-extension-demo project).
